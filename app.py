    ...
    with col2:
        ...
        with auth_tab1:
            with st.container(border=True):
                # FIXED: Added key="login_user" and key="login_pass"
    ...
    if st.session_state.current_role == "Donor (Individual/Hotel)":
        ...
        with tab1:
            ...
            with st.form("donation_form"):
                ...
                ngo_email_input = st.text_input("NGO Contact Email (To send alert) *") # ADDED FOR EMAIL
        ...
        # ... REST OF YOUR EXACT OLD CODE FOR SUPPORT NGO AND HISTORY ...
        with tab2:
