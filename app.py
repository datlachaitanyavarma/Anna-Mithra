...
# --- 2. SIDEBAR (ABOUT US) WITH YOUR NEW LOGO ---
with st.sidebar:
    # Checking if logo.jpg exists and displaying it
    if os.path.exists("logo.jpg"):
        st.image("logo.jpg", use_container_width=True)
    else:
        st.warning("Please upload 'logo.jpg' to your GitHub repository to see the logo here.")
