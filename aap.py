...
# --- 2. SIDEBAR (ABOUT US) WITH SAFE SVG LOGO ---
with st.sidebar:
    # Tablet safe single-line logo code
    logo_svg = """<div style="display: flex; justify-content: center; margin-bottom: 10px;"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200" width="130" height="130"><path d="M100,100 C60,60 20,80 40,120 C55,145 80,165 100,175 C120,165 145,145 160,120 C180,80 140,60 100,100 Z" fill="#2E8B57" opacity="0.15"/><path d="M30,120 A70,55 0 0,0 170,120 Z" fill="#FF8C00"/><path d="M30,120 A70,15 0 0,0 170,120 A70,15 0 0,0 30,120 Z" fill="#E07B00"/><path d="M75,100 Q85,60 75,30" stroke="#FF8C00" stroke-width="8" fill="none" stroke-linecap="round"/><path d="M125,100 Q115,60 125,30" stroke="#FF8C00" stroke-width="8" fill="none" stroke-linecap="round"/><path d="M100,90 Q100,50 100,20" stroke="#2E8B57" stroke-width="8" fill="none" stroke-linecap="round"/></svg></div>"""
